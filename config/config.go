...
// New function for configuration fiber
func New() *Config {
	config := &Config{
		Viper: viper.New(),
	}
...
// GetFiberConfig get all fiber configuration
func (config *Config) GetFiberConfig() *fiber.Config {
	return config.fiber
}

// GetHasherConfig get all fiber hasher
...
// GetSessionConfig get all session configuration
